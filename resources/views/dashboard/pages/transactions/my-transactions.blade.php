    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="rounded-lg dark:border-gray-700 mt-20">
                ...
                <div class="grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4 mb-4">
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                                {{ Number::abbreviate(auth()->user()->statistics()['user']['transactions']['total'] ?? 0, 2) }}
                            </h4>
                        </div>
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                                ₦ {{ Number::abbreviate(auth()->user()->statistics()['user']['transactions']['success_amount'] ?? 0, 2) }}
                            </h4>
                        </div>
                        <div class="border-t border-blue-gray-50 p-4">
                            <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                                {{ Number::abbreviate(auth()->user()->statistics()['user']['transactions']['success_total'] ?? 0, 2) }}
                            </h4>
                        </div>
                        <div class="border-t border-blue-gray-50 p-4">
                            <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                ...
                <div class="grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                                ₦ {{ Number::abbreviate(auth()->user()->statistics()['user']['transactions']['pending_amount'] ?? 0) }}
                            </h4>
                        </div>
                        <div class="dark:border-gray-500 border-t border-blue-gray-50 p-4">
                            <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                                {{ Number::abbreviate(auth()->user()->statistics()['user']['transactions']['pending_total'] ?? 0, 2) }}
                            </h4>
                        </div>
                        <div class="dark:border-gray-500 border-t border-blue-gray-50 p-4">
                            <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                                ₦ {{ Number::abbreviate(auth()->user()->statistics()['user']['installment_amount'] ?? 0, 2) }}
                            </h4>
                        </div>
                        <div class="dark:border-gray-500 border-t border-blue-gray-50 p-4">
                            <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                                {{ Number::abbreviate(auth()->user()->statistics()['user']['installments'] ?? 0, 2) }}
                            </h4>
                        </div>
                        <div class="dark:border-gray-500 border-t border-blue-gray-50 p-4">
                            <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-6 my-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                ...
                {{-- Transactions --}}
                <div class="p-2">
                    <h2 class="px-4 py-5 text-center text-xl md:text-2xl font-semibold text-gray-700 dark:text-gray-300">My Transactions</h2>
                </div>
                    {{-- Search and filter --}}
