...
@section('content')
    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="rounded-lg dark:border-gray-700 mt-20">
            ...
            <div
                class="relative overflow-x-auto shadow-md sm:rounded-lg p-6 my-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">

                {{-- Transactions --}}
                <div class="p-2">
                    <h2 class="px-4 py-5 text-center text-xl md:text-2xl font-semibold text-gray-700 dark:text-gray-300">
                        Transactions</h2>
                </div>
                {{-- Search and filter --}}
                <div
                    ...
                    <div>
                        ...
                        <div id="dropdownAction"
                            class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600 pl-3 pr-3">
                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                ...
                                <li>
                                    <a href="{{ route('transactions.index') }}?filter=full"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Full
                                        Payments</a>
                                </li>
                                <li>
                                    <a href="{{ route('transactions.index') }}?filter=installment"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Installment
                                        Payments</a>
                                </li>
                                <li>
                                    <a href="{{ route('transactions.index') }}?filter=incomplete"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Incomplete
                                        Payments</a>
                                </li>
                                <li>
                                    <a href="{{ route('transactions.index') }}?filter=successful"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Successful
                                        Payments</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <form class="w-full max-w-md mx-auto" action="">
                        ...
                        <div class="relative">
                            ...
                            <input name="search" type="search" value="{{ request('search') }}" id="default-search"
                ...
                <div>
                    <div class="text-right mt-3">
                        ...
                        <a href="{{ route('fast-excel.transactions') }}?filter={{ request('filter') }}" class="">
                            <button type="button"
                                class="inline-flex items-center px-2.5 py-1.5 text-sm font-medium text-gray-100 bg-green-500 border border-gray-300 focus:outline-none hover:bg-green-400 focus:ring-4 focus:ring-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                                <i class="fa fa-file-excel-o"></i>
                                <span class="pl-2">Export Transactions</span>
                            </button>
                        </a>
                    </div>
                </div>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr
                                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td colspan="10" class="text-center p-8">Transactions unavailable</td>
                            </tr>
                        @endforelse
