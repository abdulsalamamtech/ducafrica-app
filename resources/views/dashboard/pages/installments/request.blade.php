            ...
            <div class="my-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                ...
                <div class="relative p-8 overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-xl md:text-2xl font-semibold text-gray-700 dark:text-gray-300">Installment Requests</h2>
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <div id="dropdownDots{{ $user_installment->id }}"
                                                ...
                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                    ...
                                                    <li>
                                                        <a href="{{ route('user-installments.approve', $user_installment->id) }}"
                                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                            Approve
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('user-installments.reject', $user_installment->id) }}"
                                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                            Reject
                                                        </a>
                                                    </li>
