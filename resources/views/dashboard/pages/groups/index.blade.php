                                    ...
                                    <div class="p-6 space-y-6">
                                        <div>
                                            <label for="group_name"
                                                ...
                                                <input type="text" name="name" id="group_name"4
                                        ...
                                        <div>
                                            <label for="group_description"
                                                ...
                                                <input type="text" name="description" id="group_description"
                                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    placeholder="this Group are for premium users" required="">
                                        </div>
                                        <div class="col-span-12">
                                            <label for="group_heads"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                                Choose group head (in-charge of this group)
                                            </label>
                                            <select type="state" name="added_by" id="group_heads"
                                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Local Council">
                                                    {{-- {{ $group_heads }} --}}
                                                    @forelse ($group_heads as $group_head)
                                                        <option value="{{ $group_head->id }}">
                                                            {{ $group_head->name . ' (' . $group_head->activeRole() . ') | ' . $group_head->email}}
                                                        </option>
                                                    @empty
                            ...
                            @forelse ($groups as $group)
                                ...
                                <div id="popup-modal{{ $group->id }}" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        ...
                                        <form 
                                            action="{{ route('groups.delete', $group->id) }}" method="POST">
                                            @csrf
                                            @method("DELETE")
                                                ...
                                                <div>
                                                    <label for="Group-name"
                                                        ...
                                                        <input type="text" name="name" id="Group-name"4
                                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                            placeholder="Bonnie" required="" value="{{ $group->name }}">
                                                </div>
                                                ...
                                                <div>
                                                    <label for="Group-description"
                                                        ...
                                                        <input type="text" name="description" id="Group-description"
                                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                            placeholder="this Group are for premium users" required="" value="{{ $group->description }}">
                                                </div>
                                                ...
                                                <div class="col-span-12">
                                                    ...
                                                    <select type="state" name="added_by" id="update_local_councils"
                                                        ...
                                                        placeholder="FCT - Abuja" required="">
                                                            ...
                                                            @forelse ($group_heads as $group_head)
                                                                <option value="{{ $group_head->id }}" @if ($group_head->id == $group?->user_id) {{ 'selected' }}@endif>
                                                                    {{ $group_head->name . ' (' . $group_head->activeRole() . ') | ' . $group_head->email}}
                                                                </option>
                                                            @empty
                                                                <option value="">unavailable</option>
