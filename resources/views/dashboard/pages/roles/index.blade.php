                                        ...
                                        <div>
                                            <label for="first-name"
                                                ...
                                                <input type="text" name="description" id="role-description"
                                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    placeholder="this role are for premium users" required="">
                                        </div>
                                    </div>
                        ...
                        <tbody>
                                ...
                                <tr
                                    ...
                                    <th scope="row"
                                        ...
                                        <div class="ps-3">
                                            ...
                                            <div class="font-normal text-gray-500">{{ $role->description }}</div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="h-2.5 w-2.5 rounded-full bg-{{ $role->added_by?'green':'red' }}-500 me-2"></div> {{ $role->added_by?"Active":"Inactive" }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">

                                        <button id="dropdownMenuIconButton{{ $role->id }}" data-dropdown-toggle="dropdownDots{{ $role->id }}"
                                            ...
                                            <!-- Dropdown menu -->
                                            <div id="dropdownDots{{ $role->id }}" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconButton{{ $role->id }}">

                                                <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                    <!-- Modal toggle -->
                                                    <a href="#" type="button"
                                                        data-modal-target="editRoleModal{{ $role->id }}"
                                                        data-modal-show="editRoleModal{{ $role->id }}"
                                    ...
                                    <div class="relative w-full max-w-2xl max-h-full bg-white">
                                        ...
                                        <form action="{{ route('roles.update', $role->id) }}" method="POST"
                                            ...
                                            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                                                ...
                                                <button type="button"
                                                    class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                    data-modal-hide="editRoleModal{{ $role->id }}">
                                                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                        fill="none" viewBox="0 0 14 14">
                                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                            ...
                                            <div class="p-6 space-y-6">
                                                <div>
                                                    <label for="role-name"
                                                        ...
                                                        <input type="text" name="name" id="role-name"4
                                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                            placeholder="Bonnie" required="" value="{{ $role->name }}">
                                                </div>
                                                ...
                                                <div>
                                                    <label for="first-name"
                                                        ...
                                                        <input type="text" name="description" id="role-description"
                                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                            placeholder="this role are for premium users" required="" value="{{ $role->description }}">
                                                </div>
                                            </div>
                            ...
                            @empty
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td colspan="10" class="text-center p-8">Role unavailable</td>
                                </tr>
                            @endforelse
