                    ...
                    <div class="flex items-center justify-between flex-column md:flex-row flex-wrap space-y-4 md:space-y-0 py-4 bg-white dark:bg-gray-900 px-4">
                        ...
                        <form class="w-full max-w-md mx-auto" action="">
                            ...
                            <div class="relative">
                                ...
                                <input name="search" type="search" value="{{ request('search') }}" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." required />
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                @forelse ($booked_events as $booked_event)
                                            ...
                                            <div id="dropdownDots{{ $booked_event->id }}"
                                                ...
                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                    ...
                                                    <li
                                                        ...
                                                        <!-- Modal toggle -->
                                                        <div href="#" type="button" data-modal-target="editUserModal{{ $booked_event->id }}"
                                                            data-modal-show="editUserModal{{ $booked_event->id }}"
                                    ...
                                    <!-- Edit user modal 1 -->
                                    <div id="editUserModal{{ $booked_event->id }}" tabindex="-1" aria-hidden="true"
                                        class="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                        <div class="relative w-full max-w-2xl max-h-full bg-white dark:bg-gray-700">
                                            ...
                                            <form action="javascript::void()" method="POST"
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                        data-modal-hide="editUserModal{{ $booked_event->id }}">
                                                ...
                                                <div
                                                    ...
                                                    <button type="submit" data-modal-hide="editUserModal{{ $booked_event->id }}"
