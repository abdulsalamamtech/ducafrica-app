        ...
        <div class="rounded-lg dark:border-gray-700 mt-20">
            ...
            <div id="showEvent" class="p-6 my-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                ...
                <div class="max-w-xlg xlg:mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
                    ...
                    <div class="space-y-3 py-4 border px-2">
                        ...
                        <div class="flex justify-between items-start border-b px-2">
                            ...
                            <div class="w-7/12 text-gray-500 dark:text-gray-400">{{ $event->id . now()->format('dmY') }}
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between items-start border-b px-2">
                            ...
                            <div class="w-7/12 text-gray-500 dark:text-gray-400">{{ $event->center?->address }},
                                {{ $event->center->state }}
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between items-start border-b px-2">
                            ...
                            <div class="w-7/12 text-gray-500 dark:text-gray-400">{{ $event?->availableSlotsLimit() ?? 0 }}
                            </div>
                        </div>
                        {{-- <div class="flex justify-between items-start border-b px-2">
                ...
                <div class="overflow-x-scroll py-2">
                    <div class="p-2">
                        <h2
                            class="px-4 py-5 text-center text-xl md:text-2xl font-semibold text-gray-700 dark:text-gray-300">
                            Booked Users</h2>
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="text-right m-3">
                            <a href="{{ route('fast-excel.booked_event_users', $event) }}?action=attend" class="">
                                <button type="button"
                                    class="inline-flex items-center px-2.5 py-1.5 text-sm font-medium text-gray-100 bg-green-500 border border-gray-300 focus:outline-none hover:bg-green-400 focus:ring-4 focus:ring-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                                    <i class="fa fa-file-excel-o"></i>
                                    <span class="pl-2">Export All Attended Users</span>
                                </button>
                            </a>
                        </div>
                        <div class="text-right m-3">
                            <a href="{{ route('fast-excel.booked_event_users', $event) }}?action=absent" class="">
                                <button type="button"
                                    class="inline-flex items-center px-2.5 py-1.5 text-sm font-medium text-gray-100 bg-green-500 border border-gray-300 focus:outline-none hover:bg-green-400 focus:ring-4 focus:ring-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                                    <i class="fa fa-file-excel-o"></i>
                                    <span class="pl-2">Export All Absent Users</span>
                                </button>
                            </a>
                        </div>
                    </div>
                                ...
                                <tr
                                        ...
                                        <div class="ps-3">
                                            ...
                                            <div class="ps-3">
                                                <div class="text-base font-semibold">
                                                    {{ $booked_event?->user?->last_name . ' ' . $booked_event?->user?->first_name }}
                                                </div>
                                                <div class="font-normal text-gray-600">{{ $booked_event?->user?->email }}
                                                </div>
                                                <div class="font-normal text-gray-600">{{ $booked_event?->user?->phone }}
                                                </div>
                                                <div class="font-normal text-gray-600">
                                                    {{ $booked_event?->user?->address . ', ' . $booked_event?->user?->state }}
                                                </div>
                                            </div>
                                        </div>
                                    </th>
                                    <th>
                                        <div class="ps-3">
                                            <div class="ps-3">
                                                ...
                                                <div class="font-normal text-gray-600">
                                                    {{ $booked_event?->user?->food_allergies ?? 'none' }}</div>
                                                <div class="text-base font-semibold">Food diets</div>
                                                <div class="font-normal text-gray-600">
                                                    {{ $booked_event?->user?->diets ?? 'none' }}</div>
                                                <div class="text-base font-semibold">Disability</div>
                                                <div class="font-normal text-gray-600">
                                                    {{ $booked_event?->user?->other_disability ?? 'none' }}</div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            ...
                                            @else
                                                <div class="h-2.5 w-2.5 rounded-full bg-red-500 me-2"></div> Not Attend
                                            @endif
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">

                                        <button id="dropdownMenuIconButton{{ $booked_event->event->id }}"
                                            data-dropdown-toggle="dropdownDots{{ $booked_event->event->id }}"
                                        ...
                                        <div id="dropdownDots{{ $booked_event->event->id }}"
                                            ...
                                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                ...
                                                <li>
                                                    ...
                                                    @if ($booked_event?->attend == 'yes')
                                                        <a href="{{ route('event-attendances.absent', $booked_event->id) }}"
                                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-red-500">
                                                            Mark As Absent
                                                        </a>
                                                    @else
                                                        <a href="{{ route('event-attendances.attend', $booked_event->id) }}"
