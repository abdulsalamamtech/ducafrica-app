            ...
            <div class="my-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                ...
                <div class="relative p-8 overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-xl md:text-2xl font-semibold text-gray-700 dark:text-gray-300">My Events</h2>
                        <a href="{{ route('available-events') }}" class="px-3 md:px-4 py-2 bg-blue-800 text-white rounded-md hover:bg-blue-700">
                            <i class='fa fa-calendar'></i>
                            <span class="pl-2">View Available Events</span>
                        </a>
                    </div>
                    ...
                    <div class="text-center pt-4 bg-white dark:text-gray-100 dark:bg-gray-800">
                        <div class="px-8">
                            @if (isset($booked_events) && !empty($ebooked_vents) && $booked_events->links())
                                {{ $booked_events->links() }}
                            @endif
                        </div>
                    </div>
