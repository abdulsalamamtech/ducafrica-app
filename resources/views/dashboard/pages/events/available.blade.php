                            ...
                            <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-700 dark:text-gray-200">
                                ...
                                <div class="font-bold">
                                    ...
                                    <div class="p-2">
                                        ...
                                        <p class="text-gray-900 dark:text-gray-100">Confirmed Bookings: <span class="text-gray-500 dark:text-gray-400"> {{ $event->allBookedEventWithPayment()->count()}}</span></p>
                                        <p class="text-gray-900 dark:text-gray-100">Confirmed Bookings: <span class="text-gray-500 dark:text-gray-400"> {{ $event->confirmedBookings()->count()}}</span></p>
